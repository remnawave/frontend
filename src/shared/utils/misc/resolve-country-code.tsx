 ...
 * @see https://github.com/GertjanReynaert/country-flag-emoji-polyfill
 * @see https://gist.github.com/RienNeVaPlus/307d19b1c33fbb2545eca5c83d3bad83
 *
 * @param {String} countryCode - the country code to display a flag for (eg. US)
 * @param {String} [fallback=🏴‍☠️] - fallback icon when no matching flag has been found
