...
import { CreateDeleteMutationHookArgs } from '../interfaces'
...
>({
    ...
    errorHandler,
    rMutationParams
}: CreateDeleteMutationHookArgs<ResponseSchema, RequestQuerySchema, RouteParamsSchema>) {
    return (params?: {
        ...
        const mutationFn = async ({
            ...
            return instance
                .delete<z.infer<ResponseSchema>>(url)
                .then(async (response) => {
