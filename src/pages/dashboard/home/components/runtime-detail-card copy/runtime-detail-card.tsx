        ...
        >
            ...
            <Stack gap="sm">
                ...
                <div className={classes.memorySection}>
                    <Group justify="space-between" mb={6}>
                        ...
                        <Text className={classes.heapValues}>
                            ...
                            <span className={classes.heapPercent}>({heapPercent.toFixed(0)}%)</span>
                        </Text>
                    </Group>
                    <Progress color={config.color} radius="xl" size="sm" value={heapPercent} />
                    <Group grow mt={8}>
                        <Stack gap={0}>
                ...
                <div className={classes.perfSection}>
                    <Text c="dimmed" fw={600} lh={1} lts={1} mb={6} size="10px" tt="uppercase">
                        Event Loop
                    </Text>
                    <Group grow>
                        <Stack gap={0}>
                        ...
                        <Stack gap={0}>
                            ...
                            <Text className={classes.statValue}>{metric.activeHandles}</Text>
                        </Stack>
                    </Group>
                </div>
            </Stack>
